    ...
    <main>
        ...
        <div id="thread-tab-options" class="px-5 md:px-0">
            <div class="container mt-6 mx-auto flex space-x-2 ">
                <a class="text-gray-500 cursor-pointer" title="refresh threads">
                ...
                <a class="text-indigo-500 cursor-pointer" title="create thread">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
