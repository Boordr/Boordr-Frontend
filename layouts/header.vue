<template>
    <div>
        <header>
            ...
            <nav class="mx-auto sm:px-6 " aria-label="Top">
                <div class="w-full py-3 flex items-center justify-between border-b border-indigo-500 lg:border-none">

                    <!-- LOGO -->
                    <div class="flex items-center mx-2">
                        <NuxtLink to="/">
                            <img class="h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg"
                                alt="Logo" />
                        </NuxtLink>

                        <!-- <div class="hidden ml-10 space-x-8 lg:block">
                        <a v-for="link in navigation" :key="link.name" :href="link.href"
                            class="text-base font-medium text-indigo-500 hover:text-indigo-50">
                            {{ link.name }}
                        </a>
                    </div> -->
                    </div>
                    ...
                    <div class="flex space-x-1">
                        <a href="#"
                            class="inline-block bg-white py-2  border border-transparent rounded-md text-base font-medium text-indigo-600 hover:bg-indigo-50"></a>

                        <!-- ICONS -->
                        <a href="" title="Like on github"><svg height="30px" id="Layer_1"
                                style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512"
                                class="h-6 w-6" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                .st0{fill-rule:evenodd;clip-rule:evenodd;}<g>
                                    <path class="st0"
                        ...
                        <a href="" title="Follow on twitter"><svg id="Layer_1" class="h-6 w-6"
                                style="enable-background:new 0 0 1000 1000;" version="1.1" viewBox="0 0 1000 1000"
